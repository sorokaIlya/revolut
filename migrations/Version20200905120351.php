 ...
 */
final class Version20200905120351 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ALTER tag_id TYPE VARCHAR(255)');
        $this->addSql('ALTER TABLE post ALTER tag_id DROP DEFAULT');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ALTER tag_id TYPE INT');
        $this->addSql('ALTER TABLE post ALTER tag_id DROP DEFAULT');
    }
}
